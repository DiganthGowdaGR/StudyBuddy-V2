...
export default function A4Sheet({ title, notes }) {
  ...
  return (
    <div className="relative w-full max-w-3xl mx-auto flex flex-col min-h-[70vh] mb-36">
      {/* Notion-style Document Header */}
      <div className="border-b border-[#E6E1DA]/50 pb-4 mb-6 flex items-center justify-between gap-3">
        <h2 
          className="text-2xl md:text-3xl font-extrabold text-stone-850 tracking-tight" 
          style={{ fontFamily: 'Clash Display, sans-serif' }}
        >
          {title || 'Untitled Notes'}
        </h2>
        <span className="text-[10px] text-stone-500 font-bold bg-[#F6F4EF] border border-[#E6E1DA]/80 px-2 py-0.5 rounded-md uppercase tracking-wider">
          {saveLabel}
        </span>
      </div>

      {/* Note Editor Area */}
      <div className="relative flex-1 text-[#292524] leading-relaxed">
        <div
          ref={editorRef}
          contentEditable
          ...
          className="relative min-h-[50vh] pb-12 outline-none text-[15px] leading-8 text-stone-700 [&:empty:before]:content-[attr(data-placeholder)] [&:empty:before]:text-stone-400 [&:empty:before]:pointer-events-none [&:empty:before]:block [&:empty:before]:absolute [&:empty:before]:top-0 [&:empty:before]:left-0 [&_h1]:text-3xl [&_h1]:font-bold [&_h1]:text-stone-900 [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:text-stone-800 [&_h2]:mt-4 [&_h2]:mb-2 [&_h3]:text-xl [&_h3]:font-semibold [&_h3]:text-stone-800 [&_h3]:mt-4 [&_h3]:mb-2 [&_p]:my-1.5 [&_li]:ml-5 [&_li]:list-disc [&_blockquote]:border-l-4 [&_blockquote]:border-orange-500 [&_blockquote]:bg-[#FFF7ED] [&_blockquote]:rounded-r-lg [&_blockquote]:px-3 [&_blockquote]:py-2 [&_blockquote]:my-2"
        />

        {selectionToolbar.visible && (
          <div
            className="fixed z-50 -translate-x-1/2 rounded-lg border border-[#E6E1DA] bg-white px-2 py-1 shadow-[0_10px_30px_rgba(0,0,0,0.06)]"
          ...
          >
            <div className="flex items-center gap-1 text-[11px] text-stone-700">
              <button
                ...
                className="rounded px-2 py-1 hover:bg-[#F6F4EF] font-semibold"
              >
                H2
              </button>
              <button
              ...
              <button
                ...
                className="rounded px-2 py-1 font-bold hover:bg-[#F6F4EF]"
              >
                B
              </button>
              <button
                ...
                className="rounded px-2 py-1 italic hover:bg-[#F6F4EF] font-semibold"
              >
                I
              </button>
              <button
                ...
                className="rounded px-2 py-1 underline hover:bg-[#F6F4EF] font-semibold"
              >
                U
              </button>
              <button
              ...
              <button
                ...
                className="rounded px-2 py-1 text-red-650 hover:bg-red-50 font-bold"
              >
                Clear
              </button>
            </div>
