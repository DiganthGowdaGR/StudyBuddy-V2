    ...
    <>
      <div
        style={{
          ...
          borderRadius: '16px',
          padding: isListeningState || isSpeakingState ? '10px 16px' : '8px 12px',
          boxShadow: '0 8px 30px rgba(41,37,36,0.06)',
      ...
      {voiceError && (
        <p
          className="fixed bottom-[30px] z-[1000] max-w-[320px] -translate-x-1/2 text-center text-[10px] font-bold text-red-500 pointer-events-none"
